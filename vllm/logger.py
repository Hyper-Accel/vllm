...
def print_logger(arg, level=3):
    ...
    if level == 1:
        print(
            f"\033[91m[HJ QUESTION]\033[0m File: {filename}, Line: {line_number}, Function: {function_name}, Argument: {arg}"
        )
    elif level == 2:
        print(
            f"\033[92m[HJ HIGHLIGHT]\033[0m File: {filename}, Line: {line_number}, Function: {function_name}, Argument: {arg}"
        )
    else:
        print(
            f"\033[93m[HJ LOGGER]\033[0m File: {filename}, Line: {line_number}, Function: {function_name}, Argument: {arg}"
        )
